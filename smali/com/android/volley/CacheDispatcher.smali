...
# instance fields
.field private final dr:Ljava/util/concurrent/BlockingQueue;
...
.field private final ds:Ljava/util/concurrent/BlockingQueue;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/concurrent/BlockingQueue",
            "<",
...
.method public constructor <init>(Ljava/util/concurrent/BlockingQueue;Ljava/util/concurrent/BlockingQueue;Lcom/android/volley/Cache;Lcom/android/volley/ResponseDelivery;)V
    ...
    iput-boolean v0, p0, Lcom/android/volley/CacheDispatcher;->dv:Z

    .line 63
    iput-object p1, p0, Lcom/android/volley/CacheDispatcher;->dr:Ljava/util/concurrent/BlockingQueue;

    .line 64
    iput-object p2, p0, Lcom/android/volley/CacheDispatcher;->ds:Ljava/util/concurrent/BlockingQueue;

    .line 65
    iput-object p3, p0, Lcom/android/volley/CacheDispatcher;->dt:Lcom/android/volley/Cache;

    .line 66
    iput-object p4, p0, Lcom/android/volley/CacheDispatcher;->du:Lcom/android/volley/ResponseDelivery;

    .line 67
    return-void
.end method

.method static synthetic Code(Lcom/android/volley/CacheDispatcher;)Ljava/util/concurrent/BlockingQueue;
    .locals 1

    .prologue
    .line 40
    iget-object v0, p0, Lcom/android/volley/CacheDispatcher;->ds:Ljava/util/concurrent/BlockingQueue;
...
.method public run()V
    ...
    .line 84
    iget-object v0, p0, Lcom/android/volley/CacheDispatcher;->dt:Lcom/android/volley/Cache;
    ...
    :goto_0
    :try_start_0
    iget-object v0, p0, Lcom/android/volley/CacheDispatcher;->dr:Ljava/util/concurrent/BlockingQueue;
    ...
    iget-boolean v0, p0, Lcom/android/volley/CacheDispatcher;->dv:Z
    ...
    :cond_2
    :try_start_1
    iget-object v1, p0, Lcom/android/volley/CacheDispatcher;->dt:Lcom/android/volley/Cache;
    ...
    .line 104
    iget-object v1, p0, Lcom/android/volley/CacheDispatcher;->ds:Ljava/util/concurrent/BlockingQueue;
    ...
    .line 124
    iget-object v1, p0, Lcom/android/volley/CacheDispatcher;->du:Lcom/android/volley/ResponseDelivery;
