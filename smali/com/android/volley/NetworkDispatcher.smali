...
# instance fields
.field private final dH:Ljava/util/concurrent/BlockingQueue;
...
.method public constructor <init>(Ljava/util/concurrent/BlockingQueue;Lcom/android/volley/Network;Lcom/android/volley/Cache;Lcom/android/volley/ResponseDelivery;)V
    ...
    iput-boolean v0, p0, Lcom/android/volley/NetworkDispatcher;->dv:Z

    .line 59
    iput-object p1, p0, Lcom/android/volley/NetworkDispatcher;->dH:Ljava/util/concurrent/BlockingQueue;

    .line 60
    iput-object p2, p0, Lcom/android/volley/NetworkDispatcher;->dI:Lcom/android/volley/Network;

    .line 61
    iput-object p3, p0, Lcom/android/volley/NetworkDispatcher;->dt:Lcom/android/volley/Cache;

    .line 62
    iput-object p4, p0, Lcom/android/volley/NetworkDispatcher;->du:Lcom/android/volley/ResponseDelivery;
...
.method public run()V
    ...
    .line 90
    :try_start_0
    iget-object v0, p0, Lcom/android/volley/NetworkDispatcher;->dH:Ljava/util/concurrent/BlockingQueue;
    ...
    invoke-virtual {v1, v2, v3}, Lcom/android/volley/VolleyError;->V(J)V
    ...
    .line 1150
    iget-object v2, p0, Lcom/android/volley/NetworkDispatcher;->du:Lcom/android/volley/ResponseDelivery;

    invoke-interface {v2, v0, v1}, Lcom/android/volley/ResponseDelivery;->postError(Lcom/android/volley/Request;Lcom/android/volley/VolleyError;)V
    ...
    iget-boolean v0, p0, Lcom/android/volley/NetworkDispatcher;->dv:Z
    ...
    .line 112
    :cond_2
    iget-object v1, p0, Lcom/android/volley/NetworkDispatcher;->dI:Lcom/android/volley/Network;
    ...
    invoke-virtual {v4, v2, v3}, Lcom/android/volley/VolleyError;->V(J)V

    .line 143
    iget-object v1, p0, Lcom/android/volley/NetworkDispatcher;->du:Lcom/android/volley/ResponseDelivery;
    ...
    .line 129
    iget-object v4, p0, Lcom/android/volley/NetworkDispatcher;->dt:Lcom/android/volley/Cache;
    ...
    .line 135
    iget-object v4, p0, Lcom/android/volley/NetworkDispatcher;->du:Lcom/android/volley/ResponseDelivery;
