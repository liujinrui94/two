...
.method public create()Lcom/google/gson/Gson;
    ...
    iget-object v5, v0, Lcom/google/gson/GsonBuilder;->exclusionStrategies:Ljava/util/Collection;

    invoke-direct {v14, v5}, Ljava/util/LinkedList;-><init>(Ljava/util/Collection;)V

    .line 440
    .local v14, "serializationStrategies":Ljava/util/List;, "Ljava/util/List<Lcom/google/gson/ExclusionStrategy;>;"
    ...
    invoke-direct {v13, v5}, Ljava/util/LinkedList;-><init>(Ljava/util/Collection;)V

    .line 443
    .local v13, "deserializationStrategies":Ljava/util/List;, "Ljava/util/List<Lcom/google/gson/ExclusionStrategy;>;"
    move-object/from16 v0, p0

    iget-object v5, v0, Lcom/google/gson/GsonBuilder;->modifierBasedExclusionStrategy:Lcom/google/gson/ModifierBasedExclusionStrategy;
    ...
    iget-boolean v5, v0, Lcom/google/gson/GsonBuilder;->serializeInnerClasses:Z

    if-nez v5, :cond_0

    .line 447
    sget-object v5, Lcom/google/gson/GsonBuilder;->innerClassExclusionStrategy:Lcom/google/gson/InnerClassExclusionStrategy;
    ...
    iget-wide v0, v0, Lcom/google/gson/GsonBuilder;->ignoreVersionsAfter:D
    ...
    .line 451
    new-instance v5, Lcom/google/gson/VersionExclusionStrategy;
    ...
    invoke-direct {v5, v0, v1}, Lcom/google/gson/VersionExclusionStrategy;-><init>(D)V
    ...
    iget-boolean v5, v0, Lcom/google/gson/GsonBuilder;->excludeFieldsWithoutExposeAnnotation:Z

    if-eqz v5, :cond_2

    .line 455
    sget-object v5, Lcom/google/gson/GsonBuilder;->exposeAnnotationSerializationExclusionStrategy:Lcom/google/gson/ExposeAnnotationSerializationExclusionStrategy;

    invoke-interface {v14, v5}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .line 456
    sget-object v5, Lcom/google/gson/GsonBuilder;->exposeAnnotationDeserializationExclusionStrategy:Lcom/google/gson/ExposeAnnotationDeserializationExclusionStrategy;
    ...
    invoke-direct {v3, v14}, Lcom/google/gson/DisjunctionExclusionStrategy;-><init>(Ljava/util/Collection;)V

    .line 460
    .local v3, "serializationExclusionStrategy":Lcom/google/gson/ExclusionStrategy;
    new-instance v4, Lcom/google/gson/DisjunctionExclusionStrategy;

    invoke-direct {v4, v13}, Lcom/google/gson/DisjunctionExclusionStrategy;-><init>(Ljava/util/Collection;)V

    .line 463
    .local v4, "deserializationExclusionStrategy":Lcom/google/gson/ExclusionStrategy;
    move-object/from16 v0, p0

    iget-object v5, v0, Lcom/google/gson/GsonBuilder;->serializers:Lcom/google/gson/ParameterizedTypeHandlerMap;

    invoke-virtual {v5}, Lcom/google/gson/ParameterizedTypeHandlerMap;->copyOf()Lcom/google/gson/ParameterizedTypeHandlerMap;

    move-result-object v9

    .line 464
    .local v9, "customSerializers":Lcom/google/gson/ParameterizedTypeHandlerMap;, "Lcom/google/gson/ParameterizedTypeHandlerMap<Lcom/google/gson/JsonSerializer<*>;>;"
    move-object/from16 v0, p0

    iget-object v5, v0, Lcom/google/gson/GsonBuilder;->deserializers:Lcom/google/gson/ParameterizedTypeHandlerMap;
    ...
    .line 465
    .local v10, "customDeserializers":Lcom/google/gson/ParameterizedTypeHandlerMap;, "Lcom/google/gson/ParameterizedTypeHandlerMap<Lcom/google/gson/JsonDeserializer<*>;>;"
    move-object/from16 v0, p0

    iget-object v5, v0, Lcom/google/gson/GsonBuilder;->datePattern:Ljava/lang/String;

    move-object/from16 v0, p0

    iget v8, v0, Lcom/google/gson/GsonBuilder;->dateStyle:I

    move-object/from16 v0, p0

    iget v11, v0, Lcom/google/gson/GsonBuilder;->timeStyle:I

    invoke-static {v5, v8, v11, v9, v10}, Lcom/google/gson/GsonBuilder;->addTypeAdaptersForDate(Ljava/lang/String;IILcom/google/gson/ParameterizedTypeHandlerMap;Lcom/google/gson/ParameterizedTypeHandlerMap;)V

    .line 468
    move-object/from16 v0, p0

    iget-boolean v5, v0, Lcom/google/gson/GsonBuilder;->serializeSpecialFloatingPointValues:Z

    move-object/from16 v0, p0

    iget-object v8, v0, Lcom/google/gson/GsonBuilder;->longSerializationPolicy:Lcom/google/gson/LongSerializationPolicy;

    invoke-static {v5, v8}, Lcom/google/gson/DefaultTypeAdapters;->getDefaultSerializers(ZLcom/google/gson/LongSerializationPolicy;)Lcom/google/gson/ParameterizedTypeHandlerMap;

    move-result-object v5

    invoke-virtual {v9, v5}, Lcom/google/gson/ParameterizedTypeHandlerMap;->registerIfAbsent(Lcom/google/gson/ParameterizedTypeHandlerMap;)V
    ...
    invoke-virtual {v10, v5}, Lcom/google/gson/ParameterizedTypeHandlerMap;->registerIfAbsent(Lcom/google/gson/ParameterizedTypeHandlerMap;)V

    .line 473
    move-object/from16 v0, p0

    iget-object v5, v0, Lcom/google/gson/GsonBuilder;->instanceCreators:Lcom/google/gson/ParameterizedTypeHandlerMap;
    ...
    .line 475
    .local v12, "customInstanceCreators":Lcom/google/gson/ParameterizedTypeHandlerMap;, "Lcom/google/gson/ParameterizedTypeHandlerMap<Lcom/google/gson/InstanceCreator<*>;>;"
    ...
    invoke-virtual {v12, v5}, Lcom/google/gson/ParameterizedTypeHandlerMap;->registerIfAbsent(Lcom/google/gson/ParameterizedTypeHandlerMap;)V
    ...
    invoke-virtual {v5}, Lcom/google/gson/ParameterizedTypeHandlerMap;->makeUnmodifiable()V

    .line 481
    new-instance v6, Lcom/google/gson/MappedObjectConstructor;

    invoke-direct {v6, v12}, Lcom/google/gson/MappedObjectConstructor;-><init>(Lcom/google/gson/ParameterizedTypeHandlerMap;)V

    .line 483
    .local v6, "objConstructor":Lcom/google/gson/MappedObjectConstructor;
    move-object/from16 v0, p0

    iget-boolean v5, v0, Lcom/google/gson/GsonBuilder;->prettyPrinting:Z

    if-eqz v5, :cond_3

    new-instance v7, Lcom/google/gson/JsonPrintFormatter;

    move-object/from16 v0, p0

    iget-boolean v5, v0, Lcom/google/gson/GsonBuilder;->escapeHtmlChars:Z

    invoke-direct {v7, v5}, Lcom/google/gson/JsonPrintFormatter;-><init>(Z)V

    .line 485
    .local v7, "formatter":Lcom/google/gson/JsonFormatter;
    :goto_0
    ...
    iget-boolean v8, v0, Lcom/google/gson/GsonBuilder;->serializeNulls:Z
    ...
    .end local v7    # "formatter":Lcom/google/gson/JsonFormatter;
    :cond_3
    new-instance v7, Lcom/google/gson/JsonCompactFormatter;

    move-object/from16 v0, p0

    iget-boolean v5, v0, Lcom/google/gson/GsonBuilder;->escapeHtmlChars:Z

    invoke-direct {v7, v5}, Lcom/google/gson/JsonCompactFormatter;-><init>(Z)V
